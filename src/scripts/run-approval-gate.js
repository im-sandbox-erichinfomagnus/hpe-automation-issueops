...
async function runApprovalGate(options = {}) {
  ...
  if (
    (operation === 'team_membership' || operation === 'team_creation' || operation === 'team_hierarchy' || operation === 'team_repo_access' || operation === 'team_repo_access_removal' || operation === 'tenant_creation' || operation === 'tenant_repo_creation' || operation === 'repo_admin_membership') &&
          ...
          : auditArtifact.metadata && auditArtifact.metadata.operation === 'team_hierarchy'
            ...
            : auditArtifact.metadata && auditArtifact.metadata.operation === 'team_repo_access'
              ...
              : auditArtifact.metadata && auditArtifact.metadata.operation === 'tenant_creation'
                ? 'tenant_creation'
              : auditArtifact.metadata && ['hosted_runner_creation', 'hosted_runner_deletion', 'hosted_runner_move', 'runner_group_creation', 'tenant_variable_management', 'repo_admin_membership', 'repository_ruleset_creation', 'repository_ruleset_deletion'].includes(auditArtifact.metadata.operation)
