...
async function runApprovalGate(options = {}) {
  ...
  if (
    (operation === 'team_membership' || operation === 'team_creation' || operation === 'team_hierarchy' || operation === 'team_repo_access' || operation === 'team_repo_access_removal' || operation === 'tenant_creation' || operation === 'tenant_repo_creation' || operation === 'repo_admin_membership' || operation === 'cicd_admin_membership') &&
