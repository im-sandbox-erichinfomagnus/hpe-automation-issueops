...
const ALLOWED_CICD_ADMIN_OPERATIONS = ['add'];
...
function parseCicdAdminMembershipRequest(input = {}) {
  ...
  const cicdAdminOperation = normalizeDropdownValue(
    readField(parsed, ['cicd_admin_operation', 'parsed_cicd_admin_operation']) || input.cicdAdminOperation
  );
  ...
  return {
    ...
    cicd_admin_operation: cicdAdminOperation,
