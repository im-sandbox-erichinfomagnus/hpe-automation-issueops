...
// Mirrors resolve-cicd-admin-membership-approver (#26): the approval comment
// must come from the designated approver, who must be an active target
// organization owner.
async function resolveRepoAdminMembershipApprover(input = {}, options = {}) {
...
module.exports = {
  resolveRepoAdminMembershipApprover,
};
