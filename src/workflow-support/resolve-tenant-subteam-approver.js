...
// Mirrors resolve-repo-admin-membership-approver (#27): the approval comment
// must come from the designated approver, who must be an active target
// organization owner.
async function resolveTenantSubteamApprover(input = {}, options = {}) {
