...
// Mirrors resolve-tenant-variables-approver: the approval comment must come from
// the designated approver, who must be an active target organization owner.
async function resolveCicdAdminMembershipApprover(input = {}, options = {}) {
...
module.exports = {
  resolveCicdAdminMembershipApprover,
};
