...
function buildAuditArtifact(input = {}) {
  ...
  return {
    request: {
      ...
      repository_target_input: request.repository_target_input || '',
      repository_target_normalized: request.repository_target_normalized || '',
      ruleset_name_input: request.ruleset_name_input || '',
      ruleset_name_normalized: request.ruleset_name_normalized || '',
      ruleset_target: request.ruleset_target || '',
      ref_name_pattern: request.ref_name_pattern || '',
      enforcement: request.enforcement || '',
      require_pull_request: request.require_pull_request ?? null,
      block_force_pushes: request.block_force_pushes ?? null,
      require_linear_history: request.require_linear_history ?? null,
      restrict_deletions: request.restrict_deletions ?? null,
      requester_repository_permission: request.requester_repository_permission || '',
