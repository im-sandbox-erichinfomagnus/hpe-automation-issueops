...
function buildAuditArtifact(input = {}) {
  ...
  return {
    request: {
      ...
      subteam_operation: request.subteam_operation || null,
      ...
      ruleset_entries: request.ruleset_entries || [],
      repository_entries: request.repository_entries || [],
    ...
    reconciliation: {
      ...
      team_action: reconciliationPlan.team_action || null,
      repo_admin_team_slug: reconciliationPlan.repo_admin_team_slug || null,
      cicd_admin_team_slug: reconciliationPlan.cicd_admin_team_slug || null,
      tenant_root_team_slug: reconciliationPlan.tenant_root_team_slug || null,
      tenant_root_team_id: reconciliationPlan.tenant_root_team_id ?? null,
      maintainers_to_assign: reconciliationPlan.maintainers_to_assign || [],
      parent_team_slug: reconciliationPlan.parent_team_slug || null,
      parent_team_id: reconciliationPlan.parent_team_id ?? null,
