...
- [x] T003 [P] Implement the dependency-free enterprise cost-center REST client in src/workflow-support/github-cost-center-api.js
...
- [x] T008 Implement CSV parsing (code-fence unwrap, quoted fields, dedup, 1-based data rows) and request envelope in src/workflow-support/parse-cost-center-request.js
- [x] T009 [P] Implement the standalone audit-artifact builder in src/workflow-support/build-cost-center-artifact.js
- [x] T010 [P] Implement the human-readable summary emitter with the per-row outcome table in src/scripts/emit-cost-center-summary.js
- [x] T011 [P] Implement the designated-approver resolver in src/workflow-support/resolve-cost-center-approver.js
- [x] T012 [P] Implement the mutation policy guard assertCostCenterMutationAllowed in src/actions/cost-center-policy/index.js
...
- [x] T017 [US1] Implement per-row validation, target resolution by id then name, cross-row conflict detection, and fail-soft unverified mode in src/workflow-support/validate-cost-center-request.js
- [x] T018 [US1] Implement the deterministic create-rename-delete reconciliation plan with no_rows blocking in src/workflow-support/reconcile-cost-center-changes.js
- [x] T019 [US1] Implement the validation runner with optional live access and artifact emission in src/scripts/run-cost-center-validation.js
...
- [x] T022 [US2] Implement the approval runner that reads the latest approval comment and binds approval to the designated approver in src/scripts/run-cost-center-approval.js
...
- [x] T026 [US3] Implement the execution runner with live re-validation, deterministic mutation order, bounded retry, failure classification, terminal status, and label application in src/scripts/run-cost-center-execution.js
...
- Task: T017 [US1] in src/workflow-support/validate-cost-center-request.js
...
- Task: T022 [US2] in src/scripts/run-cost-center-approval.js
...
- Task: T026 [US3] in src/scripts/run-cost-center-execution.js
