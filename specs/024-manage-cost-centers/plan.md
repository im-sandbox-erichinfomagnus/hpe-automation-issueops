...
**Primary Dependencies**: `issue-ops/parser@v5`, the dependency-free cost-center REST client under `src/workflow-support/github-cost-center-billing-api.js`, existing approval, token-loading, and rate-limit helpers under `src/workflow-support/`, `actions/checkout`, `actions/setup-node`, `actions/upload-artifact`
...
src/
  actions/
    manage-cost-centers-policy/
      index.js
  workflow-support/
    github-cost-center-billing-api.js
    parse-manage-cost-centers-request.js
    validate-manage-cost-centers-request.js
    reconcile-manage-cost-centers-changes.js
    resolve-manage-cost-centers-approver.js
    build-manage-cost-centers-artifact.js
  scripts/
    run-manage-cost-centers-validation.js
    run-manage-cost-centers-approval.js
    run-manage-cost-centers-execution.js
    emit-manage-cost-centers-summary.js
